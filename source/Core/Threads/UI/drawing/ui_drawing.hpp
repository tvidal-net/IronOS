...
void    ui_draw_tip_temperature_readout(bool symbol, const FontStyle font); // Tip temp left-aligned, exact width (detailed readouts)
uint8_t ui_tip_temperature_readout_width(bool symbol, const FontStyle font); // Pixel width of the above (for right-aligning)
